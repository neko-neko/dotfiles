...
1. findings 全件を JSON 配列に変換する。各 finding に `selected: true/false` と `resolution_method: "dialogue" | "selection"` を付与:
   ```json
   [
     {"index": 1, "severity": "high", "category": "impl-clarity", "description": "...", "selected": true, "resolution_method": "dialogue"},
     {"index": 2, "severity": "medium", "category": "impl-feasibility", "description": "...", "selected": false, "resolution_method": "selection"}
   ]
   ```
