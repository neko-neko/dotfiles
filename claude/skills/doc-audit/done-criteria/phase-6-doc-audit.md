...
- depends_on_artifacts: [artifacts/doc-audit/phase-6-script-output.json]

### D6-02: depends-on 未宣言の解消
- severity: blocker
- verify_type: automated
...
### D6-04: 新規/更新ドキュメントの frontmatter 整備
- severity: blocker
- verify_type: automated
- verification:
  1. Phase 6 で作成/更新された md ファイルを git diff --name-only で列挙
...
- depends_on_artifacts: [artifacts/diff/phase-6-doc.diff]

### D6-05: doc-check 実行完了
- severity: blocker
- verify_type: automated
- verification:
  1. doc-check 実行ログを確認
...
- depends_on_artifacts: [artifacts/doc-audit/phase-6-doc-check.log]
...
- pass_condition: stale findings 全件の status ∈ {"updated", "skipped"} かつ "updated" の doc は最終コミットが Phase 6 開始以降
...
### D6-12: README/CONTRIBUTING/CHANGELOG 整合
- severity: quality
- verify_type: inspection
- verification:
